...
class Ai1wm_Import_Done
{
    ...
    public static function execute($params)
    {
        ...
        if (is_file(ai1wm_multisite_path($params))) {
            ...
            ai1wm_deactivate_jetpack_modules(['photon', 'sso']);
        ...
        if (ai1wm_validate_plugin_basename('fusion-builder/fusion-builder.php')) {
            Ai1wm_Status::done(
              __('Your site has been imported successfully!', AI1WM_PLUGIN_NAME),
              Ai1wm_Template::get_content(
                'import/avada',
                ['should_reset_permalinks' => $should_reset_permalinks]
              )
            );
