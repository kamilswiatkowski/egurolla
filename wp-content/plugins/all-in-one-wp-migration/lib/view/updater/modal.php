...
<div id="ai1wm-modal-dialog-<?php echo esc_attr($modal); ?>" class="ai1wm-modal-dialog">
    <div class="ai1wm-modal-container" role="dialog">
        ...
        <p><?php _e(
              'To update your plugin/extension to the latest version, please fill your Purchase ID below.',
              AI1WM_PLUGIN_NAME
            ); ?></p>
        ...
        <p>
            ...
            <a href="https://servmask.com/lost-purchase" target="_blank" class="ai1wm-help-link"><?php _e(
                  'here',
                  AI1WM_PLUGIN_NAME
                ); ?></a>
        </p>
