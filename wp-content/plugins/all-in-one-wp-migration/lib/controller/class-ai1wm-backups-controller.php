...
class Ai1wm_Backups_Controller
{
    ...
    public static function delete($params = [])
    {
        ...
        try {
            ...
            ai1wm_json_response(['errors' => [$e->getMessage()]]);
            exit;
        }
    ...
    public static function add_label($params = [])
    {
        ai1wm_setup_environment();
    ...
    public static function backup_list($params = [])
    {
        ai1wm_setup_environment();
    ...
    public static function backup_list_content($params = [])
    {
        ai1wm_setup_environment();
