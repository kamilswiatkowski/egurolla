...
class Ai1wm_Import_Controller
{
                    ...
                    foreach ($hooks as $hook) {
                        try {
                            ...
                            if (defined('WP_CLI')) {
                                WP_CLI::error(
                                  sprintf(
                                    __('Unable to import. Error code: %s. %s', AI1WM_PLUGIN_NAME),
                                    $e->getCode(),
                                    $e->getMessage()
                                  )
                                );
                    ...
                    if ($completed === false || ($next = next($filters)) && ($params['priority'] = key($filters))) {
                        ...
                        wp_remote_request(
                          ...
                          [
                            ...
                            'headers'   => apply_filters('ai1wm_http_import_headers', []),
    ...
    public static function buttons()
    {
        ...
        if (defined('AI1WMDE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_dropbox',
              Ai1wm_Template::get_content('import/button-dropbox')
            );
        } else {
        ...
        if (defined('AI1WMGE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_gdrive',
              Ai1wm_Template::get_content('import/button-gdrive')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_gdrive',
        ...
        if (defined('AI1WMOE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_onedrive',
              Ai1wm_Template::get_content('import/button-onedrive')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_onedrive',
        ...
        if (defined('AI1WMIE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_digitalocean',
              Ai1wm_Template::get_content('import/button-digitalocean')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_digitalocean',
        ...
        if (defined('AI1WMCE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_gcloud_storage',
              Ai1wm_Template::get_content('import/button-gcloud-storage')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_gcloud_storage',
        ...
        if (defined('AI1WMZE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_azure_storage',
              Ai1wm_Template::get_content('import/button-azure-storage')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_azure_storage',
        ...
        if (defined('AI1WMRE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              ...
              Ai1wm_Template::get_content('import/button-glacier')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_glacier',
        ...
        if (defined('AI1WMPE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_pcloud',
              Ai1wm_Template::get_content('import/button-pcloud')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_pcloud',
        ...
        if (defined('AI1WMWE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_webdav',
              Ai1wm_Template::get_content('import/button-webdav')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_webdav',
        ...
        if (defined('AI1WMNE_PLUGIN_NAME')) {
            $active_filters[] = apply_filters(
              'ai1wm_import_s3_client',
              Ai1wm_Template::get_content('import/button-s3-client')
            );
        } else {
            $static_filters[] = apply_filters(
              'ai1wm_import_s3_client',
    ...
    public static function http_import_headers($headers = [])
    {
