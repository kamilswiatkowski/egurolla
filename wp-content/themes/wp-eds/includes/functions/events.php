...
function get_event_box(): string
{
    ...
    $output .= '<div class="event-box__thumb" style="background-image: url(' . home_url(
      ) . '/wp-content/themes/wp-eds/dist/images/image26.jpg);"></div>';
    ...
    $output .= '<div class="event-box__bottom">';
